...
import ansibleIcon from './_assets/images/ansible_icon.png';
...
import peopleIcon from './_assets/images/people_icon.png';
            ...
            <ul>
              ...
              <li>
                <ul>
                  ...
                  <li><img src = {ansibleIcon} alt = 'ansible' /></li>
        ...
        <div className='right-side'>
          ...
          <div className='section-content'>
            <div className='content-name'>
              ...
              <span className='period'>currently</span></a>
            </div>
            ...
            <ul>
              <li>
                <div className='content-name'>
                  ...
                  <img src = {linkIcon} alt = 'link'/>
                  <span className='period'>2022</span></a></div>
              ...
              <li>
                <div className='content-name'>
                  ...
                  <img src = {linkIcon} alt = 'link'/>
                  <span className='period'>2021</span></a></div>
              ...
              <li>
                <div className='content-name'>
                  <a href='https://github.com/john-fotis/OS2'>Memort Page Replacement Simulator
                  <img src = {linkIcon} alt = 'link'/>
                  <span className='period'>2020</span></a></div>
          ...
          <div className='section-content'>
            <ul>
              <li>
                ...
                <img src = {linkIcon} alt = 'link'/></a>
              </div>
              <div className='content-description'>In-depth analysis of range and performance matters in LPWAN Networks using LoRa and LoRaWAN technologies. The study includes a series of experiments to test out several scenarios and export finding on this technology.</div>
              </li>
              <li>
                <div className='content-name'>Acquiring a Cyber Security certification
              </div>
              <div className='content-description'>Attending a Cisco-certified introductory webinar in Cyber Security threats and their dealing mechanisms.</div>
              </li>
            </ul>
          </div>
          ...
          <div className='content-description' style={{marginTop: "10px", marginLeft: "20px", marginBottom: "10px"}}>Wireless Networking, Networks Architecture, IoT, Task Automation, Cyber Security, PC Hardware</div>
          ...
          <ul className='hobbies'>
            <li>
              <ul className='hobbies-icons'>
                ...
                <li><img src = {peopleIcon} alt = 'people'/></li>
